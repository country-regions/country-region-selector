...
f=g;for(var b=document.getElementsByClassName(a),c=0;c<b.length;c++)i(b[c])},i=function(a){var c=a.getAttribute("data-crs-loaded");if("true"!==c){a.length=0;var e=a.getAttribute("data-default-option"),f=e?e:b,g=a.getAttribute("data-show-default-option");d=null===g?!0:"true"===g;var h=a.getAttribute("data-default-value"),i=a.getAttribute("data-value"),k=0;d&&(a.options[0]=new Option(f,"")),l();for(var p=o(a),q=0;q<p.length;q++){var r="shortcode"===i||"2-char"===i?p[q][1]:p[q][0];a.options[a.length]=new Option(p[q][0],r),null!=h&&h===r&&(k=q,d&&k++)}a.selectedIndex=k;var s=a.getAttribute("data-region-id");if(!s)return void console.error("Missing data-region-id on country-region-selector country field.");var t=document.getElementById(s);if(t)if(j(t),a.onchange=function(){n(a,t)},null!==h&&a.selectedIndex>0){n(a,t);var u=t.getAttribute("data-default-value"),v="shortcode"===t.getAttribute("data-value");if(null!==u){var w=d?a.selectedIndex-1:a.selectedIndex,x=p[w][3];m(t,x,u,v)}}else d===!1&&n(a,t);else console.error("Region dropdown DOM node with ID "+s+" not found.");a.setAttribute("data-crs-loaded","true")}},j=function(a){var b=a.getAttribute("data-blank-option"),c=b?b:"-",d=a.getAttribute("data-show-default-option");e=null===d?!0:"true"===d,a.length=0,e&&(a.options[0]=new Option(c,""),a.selectedIndex=0)},k=function(a){var b=0,c=[];if(a.whitelist){var d=a.whitelist.split(",");for(b=0;b<g.length;b++)-1!==d.indexOf(g[b][1])&&c.push(g[b])}else if(a.blacklist){var e=a.blacklist.split(",");for(b=0;b<g.length;b++)-1===e.indexOf(g[b][1])&&c.push(g[b])}return c},l=function(){for(var a=0;a<f.length;a++){for(var b={hasShortcodes:/~/.test(f[a][2]),regions:[]},c=f[a][2].split("|"),d=0;d<c.length;d++){var e=c[d].split("~");b.regions.push([e[0],e[1]])}f[a][3]=b}},m=function(a,b,c,d){for(var f=0;f<b.regions.length;f++){var g=d&&b.hasShortcodes&&b.regions[f][1]?b.regions[f][1]:b.regions[f][0];if(g===c){a.selectedIndex=e?f+1:f;break}}},n=function(a,b){var f=d?a.selectedIndex-1:a.selectedIndex,g=b.getAttribute("data-default-option"),h=b.getAttribute("data-value"),i=g?g:c;if(""===a.value)j(b);else{b.length=0,e&&(b.options[0]=new Option(i,""));for(var k=o(a),l=k[f][3],m=0;m<l.regions.length;m++){var n="shortcode"===h&&l.hasShortcodes?l.regions[m][1]:l.regions[m][0];b.options[b.length]=new Option(l.regions[m][0],n)}b.selectedIndex=0}},o=function(a){var b=a.getAttribute("data-whitelist"),c=a.getAttribute("data-blacklist");return b||c?k({whitelist:b,blacklist:c}):f},p=function(a,b){var c=!1,d=!0,e=a.document,f=e.documentElement,g=e.addEventListener?"addEventListener":"attachEvent",h=e.addEventListener?"removeEventListener":"detachEvent",i=e.addEventListener?"":"on",j=function(d){("readystatechange"!=d.type||"complete"==e.readyState)&&(("load"==d.type?a:e)[h](i+d.type,j,!1),!c&&(c=!0)&&b.call(a,d.type||d))},k=function(){try{f.doScroll("left")}catch(a){return void setTimeout(k,50)}j("poll")};if("complete"==e.readyState)b.call(a,"lazy");else{if(e.createEventObject&&f.doScroll){try{d=!a.frameElement}catch(l){}d&&k()}e[g](i+"DOMContentLoaded",j,!1),e[g](i+"readystatechange",j,!1),a[g](i+"load",j,!1)}};return p(window,h),{init:h}});