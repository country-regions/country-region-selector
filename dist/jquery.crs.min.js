...
$("."+a).each(h)},h=function(){var a=this,c=a.getAttribute("data-crs-loaded");if("true"!==c){a.length=0;var e=$(a).attr("data-default-option"),g=e?e:b,h=a.getAttribute("data-show-default-option");d=null===h?!0:"true"===h;var l=$(a).attr("data-default-value"),m=$(a).attr("data-value"),n=0;d&&(this.options[0]=new Option(g,""));for(var o=0;o<f.length;o++){var p="2-char"===m?f[o][1]:f[o][0];a.options[a.length]=new Option(f[o][0],p),null!=l&&l===p&&(n=o,d&&n++)}this.selectedIndex=n;var q=$(a).attr("data-region-id");if(q){var r=$("#"+q)[0];if(r)if(i(r),$(this).on("change",function(){k(a,r)}),l&&a.selectedIndex>0){k(a,r);var s=$(r).attr("data-default-value");if(null!==s){var t=f[a.selectedIndex-1][2].split("|");j(r,t,s)}}else d===!1&&k(a,r);else console.error("Region dropdown DOM node with ID "+q+" not found.")}a.setAttribute("data-crs-loaded","true")}},i=function(a){var b=$(a).attr("data-blank-option"),c=b?b:"-",d=a.getAttribute("data-show-default-option");e=null===d?!0:"true"===d,a.length=0,e&&(a.options[0]=new Option(c,""),a.selectedIndex=0)},j=function(a,b,c){for(var d=0;d<b.length;d++)if(b[d]===c){a.selectedIndex=d+1;break}},k=function(a,b){var g=d?a.selectedIndex-1:a.selectedIndex,h=$(b).attr("data-default-option"),j=h?h:c;if(""===a.value)i(b);else{b.length=0,e&&(b.options[0]=new Option(j,""));for(var k=f[g][2].split("|"),l=0;l<k.length;l++)b.options[b.length]=new Option(k[l],k[l]);b.selectedIndex=0}};return $(g),{init:g}});