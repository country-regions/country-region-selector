...
$("."+a).each(i)},i=function(){var a=this,c=a.getAttribute("data-crs-loaded");if("true"!==c){a.length=0;var e=$(a).attr("data-default-option"),h=e?e:b,i=a.getAttribute("data-show-default-option");d=null===i?!0:"true"===i;var l=$(a).attr("data-default-value"),o=$(a).attr("data-value"),p=0;d&&(this.options[0]=new Option(h,"")),k({whitelist:a.getAttribute("data-whitelist"),blacklist:a.getAttribute("data-blacklist")});for(var q=0;q<f.length;q++){var r="shortcode"==o||"2-char"===o?f[q][1]:f[q][0];a.options[a.length]=new Option(f[q][0],r),null!=l&&l===r&&(p=q,d&&p++)}this.selectedIndex=p;var s=$(a).attr("data-region-id");if(!s)return void console.error("Missing data-region-id on country-region-selector country field.");var t=$("#"+s)[0];if(t)if(j(t),$(this).on("change",function(){n(a,t)}),l&&a.selectedIndex>0){n(a,t);var u=$(t).attr("data-default-value");if(null!==u){var v=g[a.selectedIndex-1][2].split("|");m(t,v,u)}}else d===!1&&n(a,t);else console.error("Region dropdown DOM node with ID "+s+" not found.");a.setAttribute("data-crs-loaded","true")}},j=function(a){var b=$(a).attr("data-blank-option"),c=b?b:"-",d=a.getAttribute("data-show-default-option");e=null===d?!0:"true"===d,a.length=0,e&&(a.options[0]=new Option(c,""),a.selectedIndex=0)},k=function(a){var b=g,c=[],d=0;if(a.whitelist){var e=a.whitelist.split(",");for(d=0;d<g.length;d++)-1!==e.indexOf(g[d][1])&&c.push(g[d]);b=c}else if(a.blacklist){var h=a.blacklist.split(",");for(d=0;d<g.length;d++)-1===h.indexOf(g[d][1])&&c.push(g[d]);b=c}f=b,l()},l=function(){for(var a=0;a<f.length;a++){for(var b={hasShortcodes:/~/.test(f[a][2]),regions:[]},c=f[a][2].split("|"),d=0;d<c.length;d++){var e=c[d].split("~");b.regions.push([e[0],e[1]])}f[a][3]=b}},m=function(a,b,c){for(var d=0;d<b.length;d++)if(b[d]===c){a.selectedIndex=d+1;break}},n=function(a,b){var g=d?a.selectedIndex-1:a.selectedIndex,h=$(b).attr("data-default-option"),i=h?h:c;if(""===a.value)j(b);else{b.length=0,e&&(b.options[0]=new Option(i,""));for(var k=f[g][2].split("|"),l=0;l<k.length;l++)b.options[b.length]=new Option(k[l],k[l]);b.selectedIndex=0}};return $(h),{init:h}});